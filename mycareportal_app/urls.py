...
urlpatterns = [
    ...
    url(r'^delete_attachment',client_views.delete_attachment,name='delete_attachment'),
    ...
    url(r'^delete_caregiver_attachment',caregiver_views.delete_caregiver_attachment,name='delete_caregiver_attachment'),
    ...
    name='view_move_bids'),
    url(r'^view_all_family_contacts', reporting_views.ViewAllFamilymember.as_view(),name='view_all_family_contacts'),
    url(r'^view_all_providers', reporting_views.ViewAllProvider.as_view(),name='view_all_providers'),
