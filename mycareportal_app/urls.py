...
urlpatterns = [
    ...
    url(r'^post_criteria_caregiver',caregiver_views.post_criteria_caregiver,name='post_criteria_caregiver'),
    url(r'^post_certification_caregiver',caregiver_views.post_certification_caregiver,name='post_certification_caregiver'),
    url(r'^post_transfer_caregiver',caregiver_views.post_transfer_caregiver,name='post_transfer_caregiver'),
